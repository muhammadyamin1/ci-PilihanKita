...
<footer class="app-footer">
  <!--begin::To the end-->
  <div class="float-end d-none d-sm-inline">Platform Voting Digital</div>
  <!--end::To the end-->
  <!--begin::Copyright-->

  © <?= date('Y') ?> <strong>Pilihan Kita</strong>. Build with ❤️ for Democracy. All rights reserved.
  <!--end::Copyright-->
</footer>
<!--end::Footer-->
</div>
