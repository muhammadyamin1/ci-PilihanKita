...
<body class="bg-light d-flex justify-content-center align-items-center vh-100">
  <div class="card p-4 shadow" style="width: 400px;">
    <h4 class="mb-1 text-center">🗳</h4>
    <h4 class="mb-3 text-center fw-bold text-primary">Pilihan Kita</h4>
    <p class="text-center mb-4 text-muted">Masuk untuk melanjutkan</p>
